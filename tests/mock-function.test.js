...
test("test calculate without mock function", () => {
    ...
    (0, sum_1.calculate)([10, 10, 10], logging);
    (0, sum_1.calculate)([10, 10, 10, 10, 10], logging);
});
test("test mock return value", () => {
    const callback = jest.fn();
    callback.mockReturnValueOnce(40);
    callback.mockReturnValueOnce(80);
    expect((0, sum_1.calculateAndReturn)([10, 10, 10], callback)).toBe(40);
    expect((0, sum_1.calculateAndReturn)([10, 10, 10], callback)).toBe(80);
...
test("test mock implementation", () => {
    ...
    expect((0, sum_1.calculateAndReturn)([10, 10, 10], callback)).toBe(60);
    expect((0, sum_1.calculateAndReturn)([10, 10, 10, 10, 10], callback)).toBe(100);
